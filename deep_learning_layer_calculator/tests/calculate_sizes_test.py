...
def test_import_all():
    """checks if import function is importing things from csv file; not robust
       does not check if ourpur is correct because could not get file to be found in travis"""
...
def test_calculate_output_sizes_encoder():
    """compares calculated values to known set; all formulas are the same so includes variety
       no real edge cases but does test with zeros"""
       
    encoder_test_output = calculate_output_sizes_encoder([['', 'Input size', 'Padding', 'Dilation', 'Kernel Size', 'Stride', 'Output Padding (decoder only)', 'Output Size'], ['Encoder', '', '', '', '', '', '', ''], ['Conv1d', '360', '1', '1', '5', '3', '', '120'], ['Maxpool1d', '120', '0', '1', '1', '1', '', '120'], ['Conv1d', '120', '1', '1', '5', '3', '', '40'], ['Maxpool1d', '40', '0', '1', '1', '1', '', '40'], ['Conv1d', '40', '0', '1', '5', '5', '', '8'], ['Maxpool1d', '8', '0', '1', '1', '1', '', '8'], ['Decoder ', '', '', '', '', '', '', ''], ['ConvTrans1d', '8', '0', '0', '5', '5', '0', '40'], ['ConvTrans1d', '40', '1', '1', '5', '3', '0', '120'], ['ConvTrans1d', '120', '1', '1', '5', '3', '0', '360'], ['ConvTrans1d', '120', '0', '0', '0', '0', '0', '0'], ['maxUnpool', '0', '0', '0', '0', '0', '0', '0'], ['ConvTrans1d', '0', '0', '0', '0', '0', '0', '0']])
    assert encoder_test_output == [120, 120, 40, 40, 8, 8]
...
def test_calculate_output_sizes_decoder():
    ...
    assert decoder_test_output == [40, 120, 360, 0, 0, 0]
